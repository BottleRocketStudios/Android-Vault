...
public class OaepAndroidKeystoreTester extends AndroidKeystoreTester {
    public OaepAndroidKeystoreTester(Context context, String keystoreAlias, int currentSdkInt) {
    ...
    protected String getAndroidKeystoreTestStateSharedPreferenceKey(String keystoreAlias) {
        return PREF_COMPAT_FACTORY_ANDROID_KEYSTORE_TEST_STATE_ROOT + keystoreAlias + ".oaep.";
    }
    ...
    protected AbstractAndroidKeystoreSecretKeyWrapper createKeystoreSecretKeyWrapper(Context context, String testKeystoreAlias) throws GeneralSecurityException {
        return new AndroidOaepKeystoreSecretKeyWrapper(context, testKeystoreAlias);
    }
}
