...
public class AndroidKeystoreSecretKeyWrapper implements SecretKeyWrapper {
    ...
    @TargetApi(Build.VERSION_CODES.JELLY_BEAN_MR2)
    public static AlgorithmParameterSpec getVersionAppropriateAlgorithmParameterSpec(Context context, String alias, Calendar start, Calendar end, BigInteger serial, X500Principal subject) {
    ...
    @TargetApi(Build.VERSION_CODES.JELLY_BEAN_MR2)
    private static AlgorithmParameterSpec buildLegacyAlgorithmParameterSpec(Context context, String alias, Calendar start, Calendar end, BigInteger serialNumber, X500Principal subject) {
    ...
    private static AlgorithmParameterSpec buildApi23AlgorithmParameterSpec(String alias, Calendar start, Calendar end, BigInteger serialNumber, X500Principal subject) {
